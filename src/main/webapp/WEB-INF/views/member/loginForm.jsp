								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-6">
										...
										<div class="form-inline">
											<label> <a
												href="https://kauth.kakao.com/oauth/authorize?client_id=b39f6433b5558171ad972ddc2bea324a&redirect_uri=http://18.117.222.40/member/login/kakao/callback&response_type=code">
