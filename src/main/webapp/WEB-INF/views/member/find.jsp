			...
			<div class="container home-intro-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="container">
							<form id="form" class="form-horizontal" action="/member/findProc"
								method="post">
								...
								<br /> <a href="#" class="main-button accent-color">확인</a> <a
									href="#" class="main-button accent-color">뒤로</a><br /> <br />
