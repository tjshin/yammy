		...
		<ul class="main_menu">
			...
			<li><a href="#">구장별 게시판</a>
				<ul>
					...
					<li><a href="${root }/bbs/list?bbscate=jamsil"><img
							src="${root }/images/map/emblem_LG.png" style="width: 45px;"><img
							src="${root }/images/map/emblem_OB.png" style="width: 45px;">잠실(LG/두산)</a></li>
					<li><a href="${root }/bbs/list?bbscate=gocheok"><img
							src="${root }/images/map/emblem_WO.png" style="width: 45px;">고척(키움)</a></li>
					<li><a href="${root }/bbs/list?bbscate=incheon"><img
							src="${root }/images/map/emblem_SK.png" style="width: 45px;">인천(SSG)</a></li>
					<li><a href="${root }/bbs/list?bbscate=suwon"><img
							src="${root }/images/map/emblem_KT.png" style="width: 45px;">수원(KT)</a></li>
					<li><a href="${root }/bbs/list?bbscate=daejeon"><img
							src="${root }/images/map/emblem_HH.png" style="width: 45px;">대전(한화)</a></li>
					<li><a href="${root }/bbs/list?bbscate=gwangju"><img
							src="${root }/images/map/emblem_HT.png" style="width: 45px;">광주(KIA)</a></li>
					<li><a href="${root }/bbs/list?bbscate=daegu"><img
							src="${root }/images/map/emblem_SS.png" style="width: 45px;">대구(삼성)</a></li>
					<li><a href="${root }/bbs/list?bbscate=changwon"><img
							src="${root }/images/map/emblem_NC.png" style="width: 45px;">창원(NC)</a></li>
					<li><a href="${root }/bbs/list?bbscate=busan"><img
							src="${root }/images/map/emblem_LT.png" style="width: 45px;">사직(롯데)</a></li>
				...
				<c:when test="${sessionScope.grade == 'A'}">
					<li><a href="#">관리자</a>
						<ul>
							...
							<li><a href="${root }/admin/review/reply/list">전체 리뷰 댓글
									목록</a></li>
								...
								<ul class="sf-menu">
									...
									<li><a href="#">구장별 게시판</a>
										<ul>
											...
											<li><a href="${root }/bbs/list?bbscate=jamsil"><img
													src="${root }/images/map/emblem_LG.png"
													style="width: 45px;"><img
													src="${root }/images/map/emblem_OB.png"
													style="width: 45px;">잠실(LG/두산)</a></li>
											<li><a href="${root }/bbs/list?bbscate=gocheok"><img
													src="${root }/images/map/emblem_WO.png"
													style="width: 45px;">고척(키움)</a></li>
											<li><a href="${root }/bbs/list?bbscate=incheon"><img
													src="${root }/images/map/emblem_SK.png"
													style="width: 45px;">인천(SSG)</a></li>
											<li><a href="${root }/bbs/list?bbscate=suwon"><img
													src="${root }/images/map/emblem_KT.png"
													style="width: 45px;">수원(KT)</a></li>
											<li><a href="${root }/bbs/list?bbscate=daejeon"><img
													src="${root }/images/map/emblem_HH.png"
													style="width: 45px;">대전(한화)</a></li>
											<li><a href="${root }/bbs/list?bbscate=gwangju"><img
													src="${root }/images/map/emblem_HT.png"
													style="width: 45px;">광주(KIA)</a></li>
											<li><a href="${root }/bbs/list?bbscate=daegu"><img
													src="${root }/images/map/emblem_SS.png"
													style="width: 45px;">대구(삼성)</a></li>
											<li><a href="${root }/bbs/list?bbscate=changwon"><img
													src="${root }/images/map/emblem_NC.png"
													style="width: 45px;">창원(NC)</a></li>
											<li><a href="${root }/bbs/list?bbscate=busan"><img
													src="${root }/images/map/emblem_LT.png"
													style="width: 45px;">사직(롯데)</a></li>
										...
										<c:when test="${sessionScope.grade == 'A'}">
											<li><a href="#">관리자</a>
												<ul>
													...
													<li><a href="${root}/admin/message/list">전체 쪽지 목록</a></li>
													<li><a href="#">전체 게시판 댓글 목록</a></li>
													<li><a href="${root }/admin/review/reply/list">전체
															리뷰 댓글 목록</a></li>
													<li><a href="${root }/admin/ocrtest">OCR 실험실</a></li>
												</ul></li>
