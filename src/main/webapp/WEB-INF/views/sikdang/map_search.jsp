...
#menu_wrap {position:relative;width:90%;margin:0 auto;padding:5px;overflow-y:auto;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
...
function getListItem(index, places) {
    ...
    if (places.road_address_name) {
      ...
      itemStr += '  <span class="tel">' + places.phone  + '</span>' +
                '</div>';   
      itemStr +='<form class="cta" method="post" action="${root}/sikdang/create">' +
